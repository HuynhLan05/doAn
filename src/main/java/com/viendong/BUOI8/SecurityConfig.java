...
public class SecurityConfig {
    ...
    public CustomAuthenticationSuccessHandler customAuthenticationSuccessHandler() {
        return new CustomAuthenticationSuccessHandler(); // Đăng ký CustomAuthenticationSuccessHandler như một bean.
    }
...
//                        .defaultSuccessUrl("/products?loginSuccess=true") // Thêm tham số vào URL khi đăng nhập thành công.
                ...
                .httpBasic(httpBasic -> httpBasic
                        .realmName("viendong") // Tên miền cho xác thực cơ bản.
                )
